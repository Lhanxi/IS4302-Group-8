...
import {InsuranceCompany} from "./InsuranceCompany.sol";
...
contract InsuranceCompanyHandler {
    ...
    function removeInsuranceCompany(address _insuranceCompany) public {
        require(msg.sender == owner || msg.sender == _insuranceCompany, "Only owner or insurance company in question can perform this function");
