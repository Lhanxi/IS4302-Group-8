...
import axios from 'axios'; // ✅ added to fetch private key from backend
...
function DisplayPatientPage() {
    ...
    const [pin, setPin] = useState(""); // ✅ pin instead of privateKey
    ...
    const handleDecryption = async () => {
        ...
        try {
            ...
            const privKey = await getPrivateKey(doctorAddress, pin);
            ...
            const encryptedAESKey = await patientContract.getDoctorEncryptionKey(doctorAddress);
